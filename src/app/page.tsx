  ...
  return (
    <div className="flex-1 flex flex-col bg-background">
      ...
      <section className="relative overflow-hidden min-h-[92vh] flex items-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-16 lg:py-20 text-center w-full">
          {/* Badge */}
          <div className="hero-badge">
            <span className="hero-ping-dot" />
            Trusted by 10,000+ nurses nationwide
            <Sparkles className="w-3.5 h-3.5" style={{ color: "var(--primary-light)" }} />
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {[
              ...
              <div key={item.text} className="hero-feature-pill">
                <item.icon
          ...
          <p className="mt-6 text-sm font-medium" style={{ color: "var(--highlight-light)" }}>
            No credit card required · Trusted by nurses in 15+ countries
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={stat.label}
                className="group relative bg-card rounded-2xl p-6 border border-border text-center transition-all duration-300 overflow-hidden hover:border-primary-lighter hover:shadow-lg"
              >
                <div
                  className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity"
                  style={{ background: "linear-gradient(135deg, color-mix(in srgb, var(--primary) 4%, transparent), transparent)" }}
                />
                <div className="relative">
                  <div
                    className="inline-flex items-center justify-center h-12 w-12 rounded-xl mb-3 group-hover:scale-110 transition-transform"
      ...
      {/* ── How It Works ── */}
      <section className="py-24 px-6 how-it-works-bg">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={item.step}
                className="relative bg-card rounded-2xl p-8 border border-border hover:border-primary-lighter hover:-translate-y-1.5 hover:shadow-xl transition-all duration-300 group flex flex-col items-start"
              >
                <div
                  className="relative z-10 flex items-center justify-center h-[52px] w-[52px] rounded-2xl shadow-lg mb-7 group-hover:scale-110 transition-transform duration-300"
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-foreground">Why Nurse Care Pro?</h2>
            <p className="text-lg max-w-xl mx-auto" style={{ color: "var(--muted-foreground)" }}>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              },
              {
                ...
                accent: "var(--highlight)",
                glow: "var(--shadow-highlight-glow-sm)",
              },
            ].map((b) => (
              <div
                key={b.title}
                className="group bg-card rounded-2xl p-6 border border-border hover:border-primary-lighter hover:-translate-y-1 transition-all duration-300 relative overflow-hidden"
              >
                <div
                  className="absolute top-0 right-0 w-32 h-32 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -translate-y-1/2 translate-x-1/4"
                  style={{ background: b.glow }}
                />
                <div
                  className="h-12 w-12 rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 shadow-md"
                  style={{ background: b.accent }}
                >
                  <b.icon className="text-white" style={{ width: "22px", height: "22px" }} />
                </div>
      ...
      {/* ── Testimonials ── */}
      <section className="py-24 px-6 testimonials-bg">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <div className="section-label">
              <Star className="w-3 h-3 fill-current" /> Testimonials
            </div>
            <h2 className="text-4xl sm:text-5xl font-bold text-foreground">What Nurses Say</h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={t.initials}
                className="relative bg-card rounded-2xl p-7 border transition-all duration-300 group hover:-translate-y-1 hover:shadow-lg"
                style={{
                  borderColor: t.featured ? "var(--primary-lighter)" : "var(--border)",
                  boxShadow: t.featured ? "0 8px 24px -4px var(--shadow-teal-md)" : undefined,
                }}
              >
                {t.featured && (
                  <div
                    className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-1 text-white text-[11px] font-bold rounded-full tracking-wide uppercase shadow"
                ...
                <div className="flex gap-1 mb-5">
                  {[...Array(5)].map((_, j) => (
                    <Star key={j} className="h-4 w-4" style={{ fill: "var(--warning)", color: "var(--warning)" }} />
                  ))}
                </div>
                <p className="text-sm leading-relaxed italic mb-6" style={{ color: "var(--muted-foreground)" }}>
                  &ldquo;{t.quote}&rdquo;
                </p>
                <div className="flex items-center gap-3">
                  <div
                    className="h-11 w-11 rounded-full flex items-center justify-center shadow-md flex-shrink-0"
      ...
      {/* ── CTA ── */}
      <section className="py-24 px-6 relative overflow-hidden min-h-[500px] flex items-center">
        {/* Background image */}
        <div className="absolute inset-0">
          <Image
            src="/ready.png"
        ...
        {/* Decorative rings */}
        <div className="cta-ring w-[600px] h-[600px]" />
        <div className="cta-ring w-[400px] h-[400px]" style={{ borderColor: "rgba(255,255,255,0.08)" }} />
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-6">
          ...
          <p className="mt-5 text-sm font-medium" style={{ color: "var(--highlight-light)" }}>
